...
- Query EEGDash for indexed datasets and catalogue metadata before file access; verify the local cache and embedded BIDS metadata rather than trusting catalogue fields alone. [[S31]](evidence-register.md#s31)
